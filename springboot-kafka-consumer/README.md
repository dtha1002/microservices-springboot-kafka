...
* The original package name 'com.demo.springbootkafka.springboot-kafka-consumer' is invalid and this project uses 'com.demo.springbootkafka.springbootkafkaconsumer' instead.
